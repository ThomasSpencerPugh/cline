...
-   3cacd57: Adding Requesty API Provider
-   84f017c: Add Together API Provider
-   4449b51: Adding reasoning_effort support for openrouter and openai-native
-   076b1e3: Added support for AWS provider profiles using the AWS CLI to make the profile. enabling long lived connections to AWS bedrock

### Patch Changes

-   9bddd9a: Change default OpenRouter model to anthropic/claude-3.5-sonnet
-   548338d: Add Alibaba qwen models plus/max/coder-plus/turbo
-   bd5eb8f: Add automatic retry for rate limited requests
-   1935aab: Update README.md to include Getting Started
-   c88b5c6: Fix a bug where we were not properly checking for changesets in check-changeset git action
